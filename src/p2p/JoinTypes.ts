...
export interface StandbyAddRequest {
  joinRequest: JoinRequest //join request of the standby node
  cycleNumber: number //a recent cycle
  sign?: Types.Signature //sig of standby add node
}
